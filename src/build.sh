...
compiler_flags+=" -Wno-unsequenced -Wno-comment -Wno-unused-variable -Wno-unused-function -Wno-unused-result -Wno-switch -Wno-old-style-cast -Wno-zero-as-null-pointer-constant -Wno-string-conversion  -Wno-newline-eof -Wno-c++98-compat-pedantic -Wno-gnu-anonymous-struct -Wno-nested-anon-types -Wno-unused-parameter -Wno-padded -Wno-missing-prototypes -Wno-cast-align -Wno-sign-conversion -Wno-switch-enum -Wno-double-promotion -Wno-gnu-zero-variadic-macro-arguments -Wno-missing-noreturn -Wno-class-varargs -Wno-deprecated-declarations -Wno-documentation-unknown-command -Wno-weak-vtables -Wno-cast-qual -Wno-float-equal -Wno-atomic-implicit-seq-cst -Wno-char-subscripts -Wno-documentation -Wno-reserved-id-macro"
...
$CXX $compiler_flags $mac_compiler_flags -I../src/third_party/freetype2 ../src/mac_slide_opengl.mm -fPIC -shared -o ../run_tree/mac_slide_opengl.dylib -ldl $linker_flags $mac_linker_flags -framework OpenGL -L../third_party/freetype-2.10.1/bin/lib -lfreetype
